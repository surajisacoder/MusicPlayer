...
function createSong(song) {
  ...
  songElement.addEventListener("click", () => {
    currentSongEle.style.backgroundColor = checkboxEl.checked
      ? "#64696C"
      : "#0b81bc";
...
function renderAllPlaylist() {
  ...
  for (let playListName of Object.keys(playList)) {
    ...
    playListEle.style.backgroundColor = checkboxEl.checked
      ? "#64696C"
      : "#0b81bc";
...
function renderPlaylist() {
  ...
  currentPlaylist.forEach((song) => {
    ...
    songElement.style.backgroundColor = checkboxEl.checked
      ? "#64696C"
      : "#0b81bc";
